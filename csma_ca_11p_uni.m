...
PacketLength = 205; % 固定帧长 slottime 1024*8bit帧长 = 204.8 slottime 帧长
...
%}
carDistanceArray = carUniform(roadLength,M);
...
sResult((M-minCarNumber)/numberPace+1) = Throughput;
